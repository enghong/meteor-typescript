...
var CompileService = function () {
  ...
  _createClass(CompileService, [{
    ...
    value: function getDiagnostics(filePath) {
      return (0, _tsUtils.createDiagnostics)(this.service.getSyntacticDiagnostics(filePath), this.service.getSemanticDiagnostics(filePath));
    }
  }, {
    key: "rootifyPaths",
...
function createCSResult(filePath, result) {
  var props = ["code", "sourceMap", "version", "isExternal", "dependencies", "diagnostics"];
